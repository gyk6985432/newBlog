  ...
  <body>
    <div class="background">
        ...
        <script type="text/javascript">
            ...
            var bott = document.getElementsByClassName('bott')[0];
            bott.style.width= "0";
            bott.style.height= '9.375rem';
            bott.style.borderWidth = '6.5625rem 0 0 '+pageWidth+'px';
            var h = bott.style.top-50;
            bott.style.top= h+'px';

//            var h = $(document).height() -350;
//            var h = $(document).height() - 105 -150;
//            $(".bott").css("height","150px");
//            $(".bott").css("border-width","105px 0px 0px "+$(document).width()+"px");
        </script>
  </body>
</html>